...
from .views import nexus_infofile, mysql_install, user_add, user_get, nexus_mysql_script, mysql_to_slave, select_single_ecs, get_single_ecs, aliyun_ecs_assets, get_describe_regions
